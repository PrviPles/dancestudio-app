 ...
 * UPDATED with responsive data-labels.
 */
    ...
    <tbody>
        ...
        <?php else :
            ...
            <tr class="dsa-group-row" id="dsa-group-row-<?php echo esc_attr($group->ID); ?>">
                <td class="dsa-group-name" data-label="<?php esc_attr_e('Group Name', 'dancestudio-app'); ?>"><?php echo esc_html(get_the_title($group->ID)); ?></td>
